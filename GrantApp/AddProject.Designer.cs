namespace GrantApp
{
    partial class AddProject
    {
        ...
        private void InitializeComponent()
        {
			...
			this.needStatementText = new GrantApp.TextBoxWithExpandButton();
			this.objectivesText = new GrantApp.TextBoxWithExpandButton();
			this.evalPlanText = new GrantApp.TextBoxWithExpandButton();
			this.budgetText = new GrantApp.TextBoxWithExpandButton();
			this.timelineText = new GrantApp.TextBoxWithExpandButton();
		...
		private TextBoxWithExpandButton needStatementText;
		private TextBoxWithExpandButton objectivesText;
		private TextBoxWithExpandButton evalPlanText;
		private TextBoxWithExpandButton budgetText;
		private TextBoxWithExpandButton timelineText;
